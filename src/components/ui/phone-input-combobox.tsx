    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          variant={"outline"}
          className="inline-flex h-10 rounded-l-full items-center justify-between self-start text-sm font-medium ring-offset-white transition-colors disabled:pointer-events-none disabled:opacity-50 "
        >
